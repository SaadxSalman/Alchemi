...
exports.analyzeSatelliteImage = analyzeSatelliteImage;
 ...
 */
async function analyzeSatelliteImage(imageUrl) {
    try {
        ...
        console.warn(`[rust-core] unreachable at ${RUST_CORE_URL} — ` +
            `falling back to mock analysis. Reason: ${err instanceof Error ? err.message : String(err)}`);
...
//# sourceMappingURL=rustCore.js.map